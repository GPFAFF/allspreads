...
const LogoStyles = (external_styled_components_default()).div`
...
const NavStyles = (external_styled_components_default()).nav`
...
const HeaderStyles = (external_styled_components_default()).h1`
  text-align: center;
  margin-bottom: 3rem;
`;
function Header() {
...
const FooterStyles = (external_styled_components_default()).footer`
  text-align: center;
`;
function Footer() {
...
var GlobalStyles = __webpack_require__(8727);
...
const SiteBorderStyles = (external_styled_components_default()).div`
  max-width: 95vw;
...
`;
const ContentStyles = (external_styled_components_default()).div`
  padding: 2rem;
...
function Layout({ children  }) {
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx(SiteBorderStyles, {
